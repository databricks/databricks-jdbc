...
public class ResultConstants {
  ...
  static {
    final List<String> typeInfoColNames =
        Arrays.asList(
            "TYPE_NAME",
            "DATA_TYPE",
            "PRECISION",
            ...
            "SQL_DATETIME_SUB",
            "NUM_PREC_RADIX");
    final List<String> typeInfoColTypesText =
        Arrays.asList(
            "VARCHAR",
            "INTEGER",
            "INTEGER",
            ...
            "INTEGER",
            "INTEGER");
    final List<Integer> typeInfoColTypes =
        Arrays.asList(
            Types.VARCHAR,
            Types.INTEGER,
            Types.INTEGER,
            ...
            Types.INTEGER,
            Types.INTEGER);
    final List<Integer> typeInfoColTypesPrecision =
        Arrays.asList(128, 10, 10, 128, 128, 128, 5, 1, 5, 1, 1, 1, 128, 5, 5, 10, 10, 10);
    final Object[][] typeInfoRows =
        new Object[][] {
          {
            "TINYINT",
            Types.TINYINT,
    ...
    try {
      TYPE_INFO_RESULT =
          DatabricksResultSet.builder()
              ...
              .statementId("typeinfo-metadata")
              .withColumnInfoAndRows(
                  typeInfoColNames,
                  typeInfoColTypesText,
                  typeInfoColTypes,
                  typeInfoColTypesPrecision,
                  typeInfoRows)
