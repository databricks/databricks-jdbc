...
public class DatabricksPreparedStatement extends DatabricksStatement implements PreparedStatement {
  ...
  public void setObject(int parameterIndex, Object x, int targetSqlType) throws SQLException {
    ...
    throw new DatabricksSQLFeatureNotImplementedException(
        "Not implemented in DatabricksPreparedStatement - setObject(int parameterIndex, Object x, int targetSqlType)",connectionContext);
  }
  ...
  public void setCharacterStream(int parameterIndex, Reader reader, int length)
    ...
    try {
      ...
      throw new DatabricksSQLException(errorMessage, e, DatabricksDriverErrorCode.INPUT_VALIDATION_ERROR,connectionContext);
    }
  }
  ...
  public int executeUpdate(String sql) throws SQLException {
    throw new DatabricksSQLFeatureNotImplementedException("Method not supported in PreparedStatement", connectionContext);
  }
  ...
  public void addBatch(String sql) throws SQLException {
    ...
    checkIfClosed();
    throw new DatabricksSQLFeatureNotImplementedException(
        "Method not supported: addBatch(String sql)",connectionContext);
  }
  ...
  private void checkLength(long targetLength, long sourceLength) throws SQLException {
    if (targetLength != sourceLength) {
      ...
      LOGGER.error(errorMessage);
      throw new DatabricksSQLException(errorMessage, DatabricksDriverErrorCode.INVALID_STATE,connectionContext);
    }
  }
  ...
  private String readStringFromInputStream(InputStream inputStream, long length, Charset charset)
    ...
    if (inputStream == null) {
      ...
      throw new DatabricksValidationException(message, connectionContext);
    }
    try (ByteArrayOutputStream buffer = new ByteArrayOutputStream()) {
      ...
      LOGGER.error(message);
      throw new DatabricksSQLException(message, e, DatabricksDriverErrorCode.INVALID_STATE,connectionContext);
    }
  }
