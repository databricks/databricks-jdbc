  ...
  public boolean getObject(
    ...
    try {
      ...
      throw new DatabricksVolumeOperationException(
          errorMessage,
          e,
          DatabricksDriverErrorCode.VOLUME_OPERATION_FILE_DOWNLOAD_ERROR,
          connectionContext);
    }
    return true;
  }
  ...
  public boolean putObject(
    ...
    try {
      ...
      throw new DatabricksVolumeOperationException(
          errorMessage,
          e,
          DatabricksDriverErrorCode.VOLUME_OPERATION_PUT_OPERATION_EXCEPTION,
          connectionContext);
    }
    return true;
  }
  ...
  public boolean deleteObject(String catalog, String schema, String volume, String objectPath)
    ...
    try {
      ...
      throw new DatabricksVolumeOperationException(
          errorMessage,
          e,
          DatabricksDriverErrorCode.VOLUME_OPERATION_DELETE_OPERATION_EXCEPTION,
          connectionContext);
    }
    return true;
  }
