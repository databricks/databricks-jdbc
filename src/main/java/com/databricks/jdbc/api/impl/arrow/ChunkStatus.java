...
public enum ChunkStatus {
  ...
  static {
    VALID_TRANSITIONS.put(PENDING, ImmutableSet.of(URL_FETCHED, CHUNK_RELEASED, DOWNLOAD_FAILED));
    VALID_TRANSITIONS.put(
        URL_FETCHED, ImmutableSet.of(DOWNLOAD_SUCCEEDED, DOWNLOAD_FAILED, CANCELLED, CHUNK_RELEASED));
    VALID_TRANSITIONS.put(
        DOWNLOAD_SUCCEEDED, ImmutableSet.of(PROCESSING_SUCCEEDED, PROCESSING_FAILED, CHUNK_RELEASED));
    VALID_TRANSITIONS.put(PROCESSING_SUCCEEDED, ImmutableSet.of(CHUNK_RELEASED));
    VALID_TRANSITIONS.put(DOWNLOAD_FAILED, ImmutableSet.of(DOWNLOAD_RETRY, CHUNK_RELEASED));
    VALID_TRANSITIONS.put(PROCESSING_FAILED, ImmutableSet.of(CHUNK_RELEASED));
    VALID_TRANSITIONS.put(CANCELLED, ImmutableSet.of(CHUNK_RELEASED));
    VALID_TRANSITIONS.put(CHUNK_RELEASED, Collections.emptySet());
    VALID_TRANSITIONS.put(
        DOWNLOAD_RETRY, ImmutableSet.of(URL_FETCHED, DOWNLOAD_SUCCEEDED, DOWNLOAD_FAILED, CHUNK_RELEASED));
  }
