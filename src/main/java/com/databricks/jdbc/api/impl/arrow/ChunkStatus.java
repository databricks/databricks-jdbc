...
public enum ChunkStatus {
  ...
  static {
    ...
    VALID_TRANSITIONS.put(
        URL_FETCHED,
        ImmutableSet.of(DOWNLOAD_SUCCEEDED, DOWNLOAD_FAILED, CANCELLED, CHUNK_RELEASED));
    VALID_TRANSITIONS.put(
        DOWNLOAD_SUCCEEDED,
        ImmutableSet.of(PROCESSING_SUCCEEDED, PROCESSING_FAILED, CHUNK_RELEASED));
    ...
    VALID_TRANSITIONS.put(
        DOWNLOAD_RETRY,
        ImmutableSet.of(URL_FETCHED, DOWNLOAD_SUCCEEDED, DOWNLOAD_FAILED, CHUNK_RELEASED));
  }
