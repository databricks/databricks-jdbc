...
public class MetadataResultConstants {
  ...
  static final ResultColumn CATALOG_COLUMN =
  ...
  static final ResultColumn TYPE_NAME_COLUMN =
      new ResultColumn("TYPE_NAME", "TYPE_NAME", Types.VARCHAR);
  static final ResultColumn SCHEMA_COLUMN =
  ...
  static final ResultColumn TABLE_NAME_COLUMN =
  ...
  static final ResultColumn REMARKS_COLUMN = new ResultColumn("REMARKS", "remarks", Types.VARCHAR);
  ...
  static final ResultColumn COLUMN_TYPE_COLUMN =
      new ResultColumn("TYPE_NAME", "columnType", Types.VARCHAR);
  static final ResultColumn BUFFER_LENGTH_COLUMN =
      new ResultColumn("BUFFER_LENGTH", "bufferLength", Types.SMALLINT);
  static final ResultColumn COLUMN_SIZE_COLUMN =
  ...
  static final ResultColumn COLUMN_DEF_COLUMN =
      new ResultColumn("COLUMN_DEF", "columnType", Types.VARCHAR);
  static final ResultColumn DECIMAL_DIGITS_COLUMN =
      new ResultColumn("DECIMAL_DIGITS", "decimalDigits", Types.INTEGER);
  static final ResultColumn COL_NAME_COLUMN =
  ...
  static final ResultColumn NUM_PREC_RADIX_COLUMN =
  ...
  static final ResultColumn IS_NULLABLE_COLUMN =
      new ResultColumn("IS_NULLABLE", "isNullable", Types.VARCHAR);
  static final ResultColumn SQL_DATA_TYPE_COLUMN =
      new ResultColumn("SQL_DATA_TYPE", "SQLDataType", Types.SMALLINT);
  static final ResultColumn DATA_TYPE_COLUMN =
  ...
  static final ResultColumn NULLABLE_COLUMN = new ResultColumn("NULLABLE", "isNullable", Types.BIT);
  static final ResultColumn ORDINAL_POSITION_COLUMN =
      new ResultColumn("ORDINAL_POSITION", "ordinalPosition", Types.INTEGER);
  static final ResultColumn IS_AUTO_INCREMENT_COLUMN =
      new ResultColumn("IS_AUTOINCREMENT", "isAutoIncrement", Types.VARCHAR);
  static final ResultColumn IS_GENERATED_COLUMN =
