...
public class TDBSqlResultFormat extends org.apache.thrift.TUnion<TDBSqlResultFormat, TDBSqlResultFormat._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDBSqlResultFormat");
  private static final org.apache.thrift.protocol.TField ARROW_FORMAT_FIELD_DESC = new org.apache.thrift.protocol.TField("arrowFormat", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  private static final org.apache.thrift.protocol.TField CSV_FORMAT_FIELD_DESC = new org.apache.thrift.protocol.TField("csvFormat", org.apache.thrift.protocol.TType.STRUCT, (short)2);
  private static final org.apache.thrift.protocol.TField JSON_ARRAY_FORMAT_FIELD_DESC = new org.apache.thrift.protocol.TField("jsonArrayFormat", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  ...
  static {
    ...
    tmpMap.put(_Fields.ARROW_FORMAT, new org.apache.thrift.meta_data.FieldMetaData("arrowFormat", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TDBSqlArrowFormat.class)));
    tmpMap.put(_Fields.CSV_FORMAT, new org.apache.thrift.meta_data.FieldMetaData("csvFormat", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TDBSqlCsvFormat.class)));
    tmpMap.put(_Fields.JSON_ARRAY_FORMAT, new org.apache.thrift.meta_data.FieldMetaData("jsonArrayFormat", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TDBSqlJsonArrayFormat.class)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDBSqlResultFormat.class, metaDataMap);
  }
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case ARROW_FORMAT:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type TDBSqlArrowFormat for field 'arrowFormat', but got " + value.getClass().getSimpleName());
      case CSV_FORMAT:
        if (value instanceof TDBSqlCsvFormat) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TDBSqlCsvFormat for field 'csvFormat', but got " + value.getClass().getSimpleName());
      case JSON_ARRAY_FORMAT:
        if (value instanceof TDBSqlJsonArrayFormat) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TDBSqlJsonArrayFormat for field 'jsonArrayFormat', but got " + value.getClass().getSimpleName());
      default:
  ...
  public TDBSqlArrowFormat getArrowFormat() {
    if (getSetField() == _Fields.ARROW_FORMAT) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'arrowFormat' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TDBSqlCsvFormat getCsvFormat() {
    if (getSetField() == _Fields.CSV_FORMAT) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'csvFormat' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public TDBSqlJsonArrayFormat getJsonArrayFormat() {
    if (getSetField() == _Fields.JSON_ARRAY_FORMAT) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'jsonArrayFormat' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
