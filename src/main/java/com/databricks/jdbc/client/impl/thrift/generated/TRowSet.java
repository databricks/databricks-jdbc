...
public class TRowSet implements org.apache.thrift.TBase<TRowSet, TRowSet._Fields>, java.io.Serializable, Cloneable, Comparable<TRowSet> {
  ...
  private static final org.apache.thrift.protocol.TField ARROW_BATCHES_FIELD_DESC = new org.apache.thrift.protocol.TField("arrowBatches", org.apache.thrift.protocol.TType.LIST, (short)1281);
  private static final org.apache.thrift.protocol.TField RESULT_LINKS_FIELD_DESC = new org.apache.thrift.protocol.TField("resultLinks", org.apache.thrift.protocol.TType.LIST, (short)1282);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TSparkArrowBatch> arrowBatches; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<TSparkArrowResultLink> resultLinks; // optional
  ...
  private static final _Fields optionals[] = {_Fields.COLUMNS,_Fields.BINARY_COLUMNS,_Fields.COLUMN_COUNT,_Fields.ARROW_BATCHES,_Fields.RESULT_LINKS};
  ...
  static {
    ...
    tmpMap.put(_Fields.ARROW_BATCHES, new org.apache.thrift.meta_data.FieldMetaData("arrowBatches", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TSparkArrowBatch.class))));
    tmpMap.put(_Fields.RESULT_LINKS, new org.apache.thrift.meta_data.FieldMetaData("resultLinks", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TSparkArrowResultLink.class))));
  ...
  public TRowSet(TRowSet other) {
    ...
    if (other.isSetArrowBatches()) {
      java.util.List<TSparkArrowBatch> __this__arrowBatches = new java.util.ArrayList<TSparkArrowBatch>(other.arrowBatches.size());
    ...
    if (other.isSetResultLinks()) {
      java.util.List<TSparkArrowResultLink> __this__resultLinks = new java.util.ArrayList<TSparkArrowResultLink>(other.resultLinks.size());
  ...
  public TRowSet setBinaryColumns(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer binaryColumns) {
  ...
  public TRowSet setArrowBatches(@org.apache.thrift.annotation.Nullable java.util.List<TSparkArrowBatch> arrowBatches) {
  ...
  public TRowSet setResultLinks(@org.apache.thrift.annotation.Nullable java.util.List<TSparkArrowResultLink> resultLinks) {
  ...
  public boolean equals(TRowSet that) {
    ...
    if (this_present_arrowBatches || that_present_arrowBatches) {
      if (!(this_present_arrowBatches && that_present_arrowBatches))
        return false;
      if (!this.arrowBatches.equals(that.arrowBatches))
        return false;
    }
    ...
    if (this_present_resultLinks || that_present_resultLinks) {
      if (!(this_present_resultLinks && that_present_resultLinks))
        return false;
      if (!this.resultLinks.equals(that.resultLinks))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetArrowBatches())
      hashCode = hashCode * 8191 + arrowBatches.hashCode();

    hashCode = hashCode * 8191 + ((isSetResultLinks()) ? 131071 : 524287);
    if (isSetResultLinks())
      hashCode = hashCode * 8191 + resultLinks.hashCode();
  ...
  public int compareTo(TRowSet other) {
    ...
    if (isSetArrowBatches()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.arrowBatches, other.arrowBatches);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRowSet struct) throws org.apache.thrift.TException {
      ...
      if (struct.arrowBatches != null) {
        if (struct.isSetArrowBatches()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.arrowBatches.size()));
      ...
      if (struct.resultLinks != null) {
        if (struct.isSetResultLinks()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.resultLinks.size()));
