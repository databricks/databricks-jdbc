...
public class TGetCrossReferenceResp implements org.apache.thrift.TBase<TGetCrossReferenceResp, TGetCrossReferenceResp._Fields>, java.io.Serializable, Cloneable, Comparable<TGetCrossReferenceResp> {
  ...
  private static final org.apache.thrift.protocol.TField DIRECT_RESULTS_FIELD_DESC = new org.apache.thrift.protocol.TField("directResults", org.apache.thrift.protocol.TType.STRUCT, (short)1281);
  ...
  static {
    ...
    tmpMap.put(_Fields.DIRECT_RESULTS, new org.apache.thrift.meta_data.FieldMetaData("directResults", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TSparkDirectResults.class)));
  ...
  public TGetCrossReferenceResp setOperationHandle(@org.apache.thrift.annotation.Nullable TOperationHandle operationHandle) {
  ...
  public TGetCrossReferenceResp setDirectResults(@org.apache.thrift.annotation.Nullable TSparkDirectResults directResults) {
  ...
  public boolean equals(TGetCrossReferenceResp that) {
    ...
    if (this_present_directResults || that_present_directResults) {
      if (!(this_present_directResults && that_present_directResults))
        return false;
      if (!this.directResults.equals(that.directResults))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetDirectResults())
      hashCode = hashCode * 8191 + directResults.hashCode();
  ...
  public int compareTo(TGetCrossReferenceResp other) {
    ...
    if (isSetDirectResults()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.directResults, other.directResults);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
