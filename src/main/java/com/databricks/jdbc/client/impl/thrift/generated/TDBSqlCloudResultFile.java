...
public class TDBSqlCloudResultFile implements org.apache.thrift.TBase<TDBSqlCloudResultFile, TDBSqlCloudResultFile._Fields>, java.io.Serializable, Cloneable, Comparable<TDBSqlCloudResultFile> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TDBSqlCloudResultFile");
  ...
  private static final org.apache.thrift.protocol.TField START_ROW_OFFSET_FIELD_DESC = new org.apache.thrift.protocol.TField("startRowOffset", org.apache.thrift.protocol.TType.I64, (short)2);
  private static final org.apache.thrift.protocol.TField ROW_COUNT_FIELD_DESC = new org.apache.thrift.protocol.TField("rowCount", org.apache.thrift.protocol.TType.I64, (short)3);
  private static final org.apache.thrift.protocol.TField UNCOMPRESSED_BYTES_FIELD_DESC = new org.apache.thrift.protocol.TField("uncompressedBytes", org.apache.thrift.protocol.TType.I64, (short)4);
  private static final org.apache.thrift.protocol.TField COMPRESSED_BYTES_FIELD_DESC = new org.apache.thrift.protocol.TField("compressedBytes", org.apache.thrift.protocol.TType.I64, (short)5);
  private static final org.apache.thrift.protocol.TField FILE_LINK_FIELD_DESC = new org.apache.thrift.protocol.TField("fileLink", org.apache.thrift.protocol.TType.STRING, (short)6);
  private static final org.apache.thrift.protocol.TField LINK_EXPIRY_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("linkExpiryTime", org.apache.thrift.protocol.TType.I64, (short)7);
  private static final org.apache.thrift.protocol.TField HTTP_HEADERS_FIELD_DESC = new org.apache.thrift.protocol.TField("httpHeaders", org.apache.thrift.protocol.TType.MAP, (short)8);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TDBSqlCloudResultFileStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TDBSqlCloudResultFileTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> httpHeaders; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.START_ROW_OFFSET, new org.apache.thrift.meta_data.FieldMetaData("startRowOffset", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    tmpMap.put(_Fields.COMPRESSED_BYTES, new org.apache.thrift.meta_data.FieldMetaData("compressedBytes", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.FILE_LINK, new org.apache.thrift.meta_data.FieldMetaData("fileLink", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.LINK_EXPIRY_TIME, new org.apache.thrift.meta_data.FieldMetaData("linkExpiryTime", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.HTTP_HEADERS, new org.apache.thrift.meta_data.FieldMetaData("httpHeaders", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TDBSqlCloudResultFile.class, metaDataMap);
  }
  ...
  public TDBSqlCloudResultFile(TDBSqlCloudResultFile other) {
    ...
    if (other.isSetHttpHeaders()) {
      java.util.Map<java.lang.String,java.lang.String> __this__httpHeaders = new java.util.HashMap<java.lang.String,java.lang.String>(other.httpHeaders);
  ...
  public TDBSqlCloudResultFile setFilePath(@org.apache.thrift.annotation.Nullable java.lang.String filePath) {
  ...
  public TDBSqlCloudResultFile setFileLink(@org.apache.thrift.annotation.Nullable java.lang.String fileLink) {
  ...
  public void unsetLinkExpiryTime() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __LINKEXPIRYTIME_ISSET_ID);
  }
  ...
  public void setLinkExpiryTimeIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __LINKEXPIRYTIME_ISSET_ID, value);
  }
  ...
  public TDBSqlCloudResultFile setHttpHeaders(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> httpHeaders) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TDBSqlCloudResultFile)
      return this.equals((TDBSqlCloudResultFile)that);
    return false;
  }
  ...
  public boolean equals(TDBSqlCloudResultFile that) {
    ...
    if (this_present_fileLink || that_present_fileLink) {
      if (!(this_present_fileLink && that_present_fileLink))
        return false;
      if (!this.fileLink.equals(that.fileLink))
        return false;
    }
    ...
    if (this_present_linkExpiryTime || that_present_linkExpiryTime) {
      if (!(this_present_linkExpiryTime && that_present_linkExpiryTime))
        return false;
      if (this.linkExpiryTime != that.linkExpiryTime)
        return false;
    }
    ...
    if (this_present_httpHeaders || that_present_httpHeaders) {
      if (!(this_present_httpHeaders && that_present_httpHeaders))
        return false;
      if (!this.httpHeaders.equals(that.httpHeaders))
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetFileLink())
      hashCode = hashCode * 8191 + fileLink.hashCode();
    ...
    if (isSetHttpHeaders())
      hashCode = hashCode * 8191 + httpHeaders.hashCode();
  ...
  public int compareTo(TDBSqlCloudResultFile other) {
    ...
    if (isSetLinkExpiryTime()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.linkExpiryTime, other.linkExpiryTime);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class TDBSqlCloudResultFileStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TDBSqlCloudResultFileStandardScheme extends org.apache.thrift.scheme.StandardScheme<TDBSqlCloudResultFile> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TDBSqlCloudResultFile struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.httpHeaders = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map128.size);
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDBSqlCloudResultFile struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.httpHeaders != null) {
        if (struct.isSetHttpHeaders()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.httpHeaders.size()));
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter132 : struct.httpHeaders.entrySet())
            {
  ...
  private static class TDBSqlCloudResultFileTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
  ...
  private static class TDBSqlCloudResultFileTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDBSqlCloudResultFile> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TDBSqlCloudResultFile struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetHttpHeaders()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter133 : struct.httpHeaders.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TDBSqlCloudResultFile struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.httpHeaders = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map134.size);
