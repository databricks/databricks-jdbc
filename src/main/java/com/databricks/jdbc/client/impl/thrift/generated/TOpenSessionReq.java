...
public class TOpenSessionReq implements org.apache.thrift.TBase<TOpenSessionReq, TOpenSessionReq._Fields>, java.io.Serializable, Cloneable, Comparable<TOpenSessionReq> {
  ...
  private static final org.apache.thrift.protocol.TField GET_INFOS_FIELD_DESC = new org.apache.thrift.protocol.TField("getInfos", org.apache.thrift.protocol.TType.LIST, (short)1281);
  private static final org.apache.thrift.protocol.TField CLIENT_PROTOCOL_I64_FIELD_DESC = new org.apache.thrift.protocol.TField("client_protocol_i64", org.apache.thrift.protocol.TType.I64, (short)1282);
  private static final org.apache.thrift.protocol.TField CONNECTION_PROPERTIES_FIELD_DESC = new org.apache.thrift.protocol.TField("connectionProperties", org.apache.thrift.protocol.TType.MAP, (short)1283);
  private static final org.apache.thrift.protocol.TField INITIAL_NAMESPACE_FIELD_DESC = new org.apache.thrift.protocol.TField("initialNamespace", org.apache.thrift.protocol.TType.STRUCT, (short)1284);
  private static final org.apache.thrift.protocol.TField CAN_USE_MULTIPLE_CATALOGS_FIELD_DESC = new org.apache.thrift.protocol.TField("canUseMultipleCatalogs", org.apache.thrift.protocol.TType.BOOL, (short)1285);
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> connectionProperties; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.CONFIGURATION, new org.apache.thrift.meta_data.FieldMetaData("configuration", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    tmpMap.put(_Fields.GET_INFOS, new org.apache.thrift.meta_data.FieldMetaData("getInfos", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    tmpMap.put(_Fields.CONNECTION_PROPERTIES, new org.apache.thrift.meta_data.FieldMetaData("connectionProperties", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING), 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING))));
    ...
    tmpMap.put(_Fields.CAN_USE_MULTIPLE_CATALOGS, new org.apache.thrift.meta_data.FieldMetaData("canUseMultipleCatalogs", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public TOpenSessionReq() {
    this.client_protocol = com.databricks.jdbc.client.impl.thrift.generated.TProtocolVersion.__HIVE_JDBC_WORKAROUND;
  ...
  public TOpenSessionReq(TOpenSessionReq other) {
    ...
    if (other.isSetGetInfos()) {
      java.util.List<TGetInfoType> __this__getInfos = new java.util.ArrayList<TGetInfoType>(other.getInfos.size());
    ...
    if (other.isSetConnectionProperties()) {
      java.util.Map<java.lang.String,java.lang.String> __this__connectionProperties = new java.util.HashMap<java.lang.String,java.lang.String>(other.connectionProperties);
  ...
  public TOpenSessionReq setGetInfos(@org.apache.thrift.annotation.Nullable java.util.List<TGetInfoType> getInfos) {
  ...
  public TOpenSessionReq setConnectionProperties(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> connectionProperties) {
  ...
  public TOpenSessionReq setInitialNamespace(@org.apache.thrift.annotation.Nullable TNamespace initialNamespace) {
  ...
  public void unsetCanUseMultipleCatalogs() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CANUSEMULTIPLECATALOGS_ISSET_ID);
  }
  ...
  public boolean isSetCanUseMultipleCatalogs() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CANUSEMULTIPLECATALOGS_ISSET_ID);
  }

  public void setCanUseMultipleCatalogsIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CANUSEMULTIPLECATALOGS_ISSET_ID, value);
  }
  ...
  public boolean equals(TOpenSessionReq that) {
    ...
    if (this_present_getInfos || that_present_getInfos) {
      if (!(this_present_getInfos && that_present_getInfos))
        return false;
      if (!this.getInfos.equals(that.getInfos))
        return false;
    }
    ...
    if (this_present_connectionProperties || that_present_connectionProperties) {
      if (!(this_present_connectionProperties && that_present_connectionProperties))
        return false;
      if (!this.connectionProperties.equals(that.connectionProperties))
        return false;
    }
    ...
    if (this_present_canUseMultipleCatalogs || that_present_canUseMultipleCatalogs) {
      if (!(this_present_canUseMultipleCatalogs && that_present_canUseMultipleCatalogs))
        return false;
      if (this.canUseMultipleCatalogs != that.canUseMultipleCatalogs)
        return false;
    }
  ...
  public int hashCode() {
    ...
    if (isSetGetInfos())
      hashCode = hashCode * 8191 + getInfos.hashCode();
    ...
    if (isSetConnectionProperties())
      hashCode = hashCode * 8191 + connectionProperties.hashCode();
  ...
  public int compareTo(TOpenSessionReq other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetConnectionProperties(), other.isSetConnectionProperties());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetConnectionProperties()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.connectionProperties, other.connectionProperties);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = java.lang.Boolean.compare(isSetCanUseMultipleCatalogs(), other.isSetCanUseMultipleCatalogs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCanUseMultipleCatalogs()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.canUseMultipleCatalogs, other.canUseMultipleCatalogs);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configuration = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map232.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem237 = com.databricks.jdbc.client.impl.thrift.generated.TGetInfoType.findByValue(iprot.readI32());
                  if (_elem237 != null)
                  {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.connectionProperties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map239.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOpenSessionReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.configuration != null) {
        if (struct.isSetConfiguration()) {
          oprot.writeFieldBegin(CONFIGURATION_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter243 : struct.configuration.entrySet())
            {
      ...
      if (struct.getInfos != null) {
        if (struct.isSetGetInfos()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, struct.getInfos.size()));
      ...
      if (struct.connectionProperties != null) {
        if (struct.isSetConnectionProperties()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.connectionProperties.size()));
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter245 : struct.connectionProperties.entrySet())
            {
      ...
      if (struct.isSetConfiguration()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter246 : struct.configuration.entrySet())
          {
      ...
      if (struct.isSetConnectionProperties()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter248 : struct.connectionProperties.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.configuration = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map249.size);
      ...
      if (incoming.get(4)) {
        {
          ...
          {
            _elem254 = com.databricks.jdbc.client.impl.thrift.generated.TGetInfoType.findByValue(iprot.readI32());
            if (_elem254 != null)
            {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.connectionProperties = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map256.size);
