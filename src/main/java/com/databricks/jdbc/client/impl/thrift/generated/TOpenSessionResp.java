...
public class TOpenSessionResp implements org.apache.thrift.TBase<TOpenSessionResp, TOpenSessionResp._Fields>, java.io.Serializable, Cloneable, Comparable<TOpenSessionResp> {
  ...
  public TOpenSessionResp(TOpenSessionResp other) {
    ...
    if (other.isSetGetInfos()) {
      java.util.List<TGetInfoValue> __this__getInfos = new java.util.ArrayList<TGetInfoValue>(other.getInfos.size());
  ...
  public TOpenSessionResp setInitialNamespace(@org.apache.thrift.annotation.Nullable TNamespace initialNamespace) {
  ...
  public TOpenSessionResp setGetInfos(@org.apache.thrift.annotation.Nullable java.util.List<TGetInfoValue> getInfos) {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SERVER_PROTOCOL_VERSION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.serverProtocolVersion = com.databricks.jdbc.client.impl.thrift.generated.TProtocolVersion.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configuration = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map260.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOpenSessionResp struct) throws org.apache.thrift.TException {
      ...
      if (struct.configuration != null) {
        if (struct.isSetConfiguration()) {
          oprot.writeFieldBegin(CONFIGURATION_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter267 : struct.configuration.entrySet())
            {
      ...
      if (struct.getInfos != null) {
        if (struct.isSetGetInfos()) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.getInfos.size()));
  ...
  private static class TOpenSessionRespTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOpenSessionResp> {
      ...
      if (struct.isSetConfiguration()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter269 : struct.configuration.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOpenSessionResp struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map271 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.configuration = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map271.size);
