...
public class DriverTester {
  ...
  void testGetTablesOSS_StatementExecution() throws Exception {
    ...
    Connection con = DriverManager.getConnection(jdbcUrl, "userEmail", "x");
  ...
  void testLogging() throws Exception {
    ...
    DriverManager.drivers().forEach(driver -> System.out.println(driver.getClass()));
    String jdbcUrl =
        "jdbc:databricks://e2-dogfood.staging.cloud.databricks.com:443/default;transportMode=https;ssl=1;httpPath=sql/protocolv1/o/6051921418418893/1115-130834-ms4m0yv;AuthMech=3;UID=token;LogLevel=debug;LogPath=beautifulLogs;LogFileCount=3;LogFileSize=2;";
    Connection con = DriverManager.getConnection(jdbcUrl, "userEmail", "x");
    System.out.println("Connection established......");
    ResultSet resultSet =
        con.createStatement()
