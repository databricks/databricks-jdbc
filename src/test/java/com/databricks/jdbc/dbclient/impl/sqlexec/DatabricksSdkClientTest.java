...
public class DatabricksSdkClientTest {
  ...
  private static Map<Integer, ImmutableSqlParameter> sqlParams;

  static {
    sqlParams = new HashMap<Integer, ImmutableSqlParameter>();
    sqlParams.put(1, getSqlParam(1, 100, DatabricksTypeUtil.BIGINT));
    sqlParams.put(2, getSqlParam(2, (short) 10, DatabricksTypeUtil.SMALLINT));
    sqlParams.put(3, getSqlParam(3, (byte) 15, DatabricksTypeUtil.TINYINT));
