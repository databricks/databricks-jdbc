...
public class DatabricksDriverPropertyUtilTest {
  private void assertMissingProperties(String connectionParamString, String... expectedProperties)
      throws DatabricksSQLException {
    List<DriverPropertyInfo> missingProperties =
        DatabricksDriverPropertyUtil.getMissingProperties(connectionParamString, new Properties());
  ...
  public void testGetMissingProperties() throws DatabricksSQLException {
    ...
    assertMissingProperties(connectionParamString, AUTH_FLOW.getParamName());
