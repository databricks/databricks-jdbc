...
public class DatabricksPreparedStatementTest {
    ...
    public void testExecuteStatement() throws Exception {
        ...
        when(client.executeStatement(eq(STATEMENT),
                eq(WAREHOUSE_ID),
                eq(new HashMap<Integer, ImmutableSqlParameter>()),
                eq(StatementType.QUERY), any(IDatabricksSession.class),
                eq(statement))).thenReturn(resultSet);
    ...
    public void testExecuteUpdateStatement() throws Exception {
        ...
        when(client.executeStatement(eq(STATEMENT), eq(WAREHOUSE_ID), eq(new HashMap<Integer, ImmutableSqlParameter>()), eq(StatementType.UPDATE), any(IDatabricksSession.class), eq(statement))).thenReturn(resultSet);
