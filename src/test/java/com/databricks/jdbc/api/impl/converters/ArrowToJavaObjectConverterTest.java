...
public class ArrowToJavaObjectConverterTest {
  ...
  public void testBigDecimalConversion() throws SQLException {
    ...
    ColumnInfo decimalColumnInfo = new ColumnInfo().setTypeScale(30L).setTypePrecision(10L);
    Object convertedObject =
        ArrowToJavaObjectConverter.convert(
  ...
  public void testConvertToDecimal() throws DatabricksValidationException {
    ...
    ColumnInfo columnInfo = new ColumnInfo().setTypeScale(10L).setTypePrecision(3L);
    ...
    columnInfo = new ColumnInfo().setTypeScale(10L).setTypePrecision(2L);
    columnInfo.setTypeName(ColumnInfoTypeName.DECIMAL);
    ...
    columnInfo = new ColumnInfo().setTypeScale(10L).setTypePrecision(0L);
    columnInfo.setTypeName(ColumnInfoTypeName.DECIMAL);
    ...
    assertThrows(
        DatabricksValidationException.class,
        () -> {
          ColumnInfo errorColumnInfo = new ColumnInfo().setTypeScale(10L).setTypePrecision(2L);
    ...
    columnInfo = new ColumnInfo().setTypeScale(10L).setTypePrecision(4L);
    columnInfo.setTypeName(ColumnInfoTypeName.DECIMAL);
