...
public class ComplexDataTypeParserTest {
    ...
    void testComplexPrimitiveConversions() {
        ...
        // Suppose your real parseStructMetadata(...) for "STRUCT<dec:DECIMAL,dt:DATE,tm:TIME,ts:TIMESTAMP>"
        // returns { dec=DECIMAL, dt=DATE, tm=TIME, ts=TIMESTAMP }
        DatabricksStruct dbStruct = parser.parseJsonStringToDbStruct(
                json, "STRUCT<dec:DECIMAL,dt:DATE,tm:TIME,ts:TIMESTAMP>");
        assertNotNull(dbStruct);
