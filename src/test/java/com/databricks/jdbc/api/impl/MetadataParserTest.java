...
public class MetadataParserTest {
    ...
    public void testParseStructMetadata_NestedStruct() {
        ...
        Map<String, String> actual = MetadataParser.parseStructMetadata(metadata);
        assertEquals(expected, actual, "Parsed struct metadata with nested STRUCT should match expected field types.");
    }
    ...
    public void testParseStructMetadata_NestedArray() {
        ...
        Map<String, String> actual = MetadataParser.parseStructMetadata(metadata);
        assertEquals(expected, actual, "Parsed struct metadata with nested ARRAY should match expected field types.");
    }
    ...
    public void testParseStructMetadata_NestedMap() {
        ...
        Map<String, String> actual = MetadataParser.parseStructMetadata(metadata);
        assertEquals(expected, actual, "Parsed struct metadata with nested MAP should match expected field types.");
    }
    ...
    public void testParseStructMetadata_MultipleLevelsOfNesting() {
        String metadata = "STRUCT<id:INT, address:STRUCT<street:STRING, city:STRUCT<name:STRING, code:INT>>, active:BOOLEAN>";
        Map<String, String> expected = new LinkedHashMap<>();
        expected.put("id", "INT");
        ...
        Map<String, String> actual = MetadataParser.parseStructMetadata(metadata);
        assertEquals(expected, actual, "Parsed struct metadata with multiple levels of nesting should match expected field types.");
    }
    ...
    public void testParseArrayMetadata_NestedStructElementType() {
        ...
        String actual = MetadataParser.parseArrayMetadata(metadata);
        assertEquals(expected, actual, "Parsed array metadata with nested STRUCT should match expected element type.");
    }
    ...
    public void testParseArrayMetadata_NestedArrayElementType() {
        ...
        String actual = MetadataParser.parseArrayMetadata(metadata);
        assertEquals(expected, actual, "Parsed array metadata with nested ARRAY should match expected element type.");
    }
    ...
    public void testParseMapMetadata_SimpleKeyValueTypes() {
        ...
        assertEquals(expected, actual, "Parsed map metadata should match the expected key and value types.");
    }
    ...
    public void testParseMapMetadata_NestedStructKeyType() {
        ...
        String actual = MetadataParser.parseMapMetadata(metadata);
        assertEquals(expected, actual, "Parsed map metadata with nested STRUCT key type should match expected key and value types.");
    }
    ...
    public void testParseMapMetadata_NestedArrayValueType() {
        ...
        String actual = MetadataParser.parseMapMetadata(metadata);
        assertEquals(expected, actual, "Parsed map metadata with nested ARRAY value type should match expected key and value types.");
    }
    ...
    public void testParseMapMetadata_NestedMapValueType() {
        ...
        String actual = MetadataParser.parseMapMetadata(metadata);
        assertEquals(expected, actual, "Parsed map metadata with nested MAP value type should match expected key and value types.");
    }

    /**
     * Test parsing of MAP metadata with invalid format (missing comma).
    ...
    public void testParseMapMetadata_InvalidFormat_NoComma() {
        ...
        assertTrue(exception.getMessage().contains("Invalid MAP metadata"), "Exception message should indicate invalid MAP metadata.");
    }

    /**
     * Test the cleanTypeName method to ensure it removes "NOT NULL" constraints and trims the type name.
     */
    @Test
    ...
    public void testCleanTypeName_RemovesNotNull() {
        ...
        assertEquals(expected, actual, "cleanTypeName should remove 'NOT NULL' and trim the type name.");
    }
    ...
    public void testParseStructMetadata_WithNotNullConstraints() {
        ...
        Map<String, String> actual = MetadataParser.parseStructMetadata(metadata);
        assertEquals(expected, actual, "Parsed struct metadata should correctly remove 'NOT NULL' constraints.");
    }
    ...
    public void testParseArrayMetadata_WithNotNullConstraints() {
        ...
        String actual = MetadataParser.parseArrayMetadata(metadata);
        assertEquals(expected, actual, "Parsed array metadata should correctly remove 'NOT NULL' constraints.");
    }
    ...
    public void testParseMapMetadata_WithNotNullConstraints() {
        ...
        String actual = MetadataParser.parseMapMetadata(metadata);
        assertEquals(expected, actual, "Parsed map metadata should correctly remove 'NOT NULL' constraints.");
    }

    /**
     * Test parsing of empty MAP metadata.
     * Expects IllegalArgumentException.
     */
    @Test
    ...
    public void testParseMapMetadata_EmptyMap() {
        ...
        assertTrue(exception.getMessage().contains("Invalid MAP metadata"),
