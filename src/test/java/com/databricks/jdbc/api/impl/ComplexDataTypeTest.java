...
public class ComplexDataTypeTest {
    ...
    public void testArrayOfStructsWithNestedStructs() throws SQLException {
        ...
        List<Object> elements = Arrays.asList(structData1, structData2);
        String metadata = "ARRAY<STRUCT<age:INT, email:STRING, address:STRUCT<city:STRING, zip:STRING>>>";
    ...
    public void testComplexStructWithMapAndArray() throws SQLException {
        ...
        String metadata = "STRUCT<team:STRUCT<lead:STRUCT<name:STRING, age:INT>, members:ARRAY<STRUCT<name:STRING, age:INT>>>, projects:ARRAY<STRUCT<name:STRING, duration:STRING>>>";
    ...
    public void testStructWithPrimitives() throws SQLException {
        ...
        String metadata = "STRUCT<intField:INT, floatField:FLOAT, boolField:BOOLEAN, stringField:STRING>";
