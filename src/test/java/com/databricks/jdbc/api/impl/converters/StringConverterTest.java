...
public class StringConverterTest {
  ...
  private final String ALT_TIMESTAMP_STRING_WITH_EXTRA_QUOTES = "\"2025-03-18 12:08:31.552223-07:00\"";
  ...
  public void testConvertToTimestamp() throws DatabricksSQLException, ParseException {
    ...
    assertEquals(
            new StringConverter().toTimestamp(ALT_TIMESTAMP_STRING_WITH_EXTRA_QUOTES), new Timestamp(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSSSSSXXX").parse(ALT_TIMESTAMP_STRING).getTime()));
  }

  @Test
  public void testConvertToDate() throws DatabricksSQLException {
    assertEquals(new StringConverter().toDate(DATE_STRING), Date.valueOf(DATE_STRING));
    assertEquals(new StringConverter().toDate(DATE_STRING_WITH_EXTRA_QUOTES), Date.valueOf(DATE_STRING));
  }
