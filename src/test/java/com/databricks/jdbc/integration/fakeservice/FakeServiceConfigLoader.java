...
public class FakeServiceConfigLoader {
  ...
  private static final String SQL_GATEWAY_WAREHOUSE_FAKE_SERVICE_TEST_PROPS =
      "sqlgatewaywarehousefakeservicetest.properties";

  public enum ConnectionInfoType {
    SQL_GATEWAY_WAREHOUSE,
    SQL_GATEWAY,
    SQL_EXEC
  }
  ...
  private static String getPropsFileName() {
    switch (connectionInfo) {
      case SQL_GATEWAY_WAREHOUSE:
        return SQL_GATEWAY_WAREHOUSE_FAKE_SERVICE_TEST_PROPS;
      case SQL_GATEWAY:
