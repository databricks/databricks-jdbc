...
- Never carry over fakeservice or e2e tests — they depend on WireMock 3.x (Java 11+) and live Databricks credentials respectively. Remove them and their test resources entirely.
